 ...
 */
package blanco.csv.task.valueobject;

/**
 * 処理クラス [BlancoCsvProcess]の入力バリューオブジェクトクラスです。
 */
public class BlancoCsvProcessInput {
    /**
    ...
    /**
     * ランタイムクラスを生成する生成先を指定します。無指定の場合には ファイル定義書(CSV)の値を基準に生成されます。
     *
     ...
     *
     * フィールドの説明: [ランタイムクラスを生成する生成先を指定します。無指定の場合には ファイル定義書(CSV)の値を基準に生成されます。]。
     *
    ...
    public String toString() {
        ...
        buf.append("blanco.csv.task.valueobject.BlancoCsvProcessInput[");
