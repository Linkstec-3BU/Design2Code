...
/**
 * 処理 [BlancoCsvProcess]インタフェース。
 *
 * このインタフェースを継承して [blanco.csv.task]パッケージに[BlancoCsvProcess]クラスを作成して実際のバッチ処理を実装してください。<br>
 */
interface BlancoCsvProcess {
    /**
     ...
     */
    int execute(final BlancoCsvProcessInput input) throws IOException, IllegalArgumentException;
