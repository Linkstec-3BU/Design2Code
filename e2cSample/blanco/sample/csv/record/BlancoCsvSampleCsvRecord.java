 ...
 *
 * ファイル定義[BlancoCsvSample/このクラスは単にサンプルです。実際の動作には利用されません。]のレコードクラス。
 */
public class BlancoCsvSampleCsvRecord {
    /**
     * フィールド1
     *
     * 項目番号: 1
    ...
    public String toString() {
        ...
        buf.append("blanco.sample.csv.record.BlancoCsvSampleCsvRecord[");
