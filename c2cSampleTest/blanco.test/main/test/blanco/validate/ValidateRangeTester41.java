/*
 * このクラスは 'AbstractValidateRangeTester41' の具象クラスとして blanco Framework によって自動生成されました。
 */
...
public class ValidateRangeTester41 extends AbstractValidateRangeTester41 {
    /**
     * 処理対象となるフィールド。
    ...
    public String validateField01(final String locationInfo) {
        ...
        if (field01 == null || field01.length() == 0) {
            ...
            return locationInfo + "「フィールド１」は 3.3 以上で入力してください。";
        }
        return null;
    }
    ...
    public boolean validateField01(final ActionMessages actionMessages, final String locationInfo) {
        ...
        if (field01 == null || field01.length() == 0) {
            ...
            final ActionMessage msg = new ActionMessage("message.blanco.validate.range.min.locationinfo", locationInfo, "フィールド１", "3.3");
