/*
 * このクラスは 'AbstractValidateLengthTester11' の具象クラスとして blanco Framework によって自動生成されました。
 */
...
public class ValidateLengthTester11 extends AbstractValidateLengthTester11 {
    /**
     * シリアルバージョン UID.
     */
    ...
    public boolean validateField01(final ActionMessages actionMessages) {
        // [@BlancoValidateLength]
        {
            ...
            if (value.length() == 0) {
                ...
                final ActionMessage msg = new ActionMessage("message.blanco.validate.length.min", "フィールド１", "3");
