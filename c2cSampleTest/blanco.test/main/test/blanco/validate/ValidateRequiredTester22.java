/*
 * このクラスは 'AbstractValidateRequiredTester22' の具象クラスとして blanco Framework によって自動生成されました。
 */
...
public class ValidateRequiredTester22 extends AbstractValidateRequiredTester22 {
    /**
     * シリアルバージョン UID.
     */
    ...
    public boolean validateField01(final ActionMessages actionMessages) {
        // [@BlancoValidateRequired]
        if (field01 == null || BlancoValidateRuntimeUtil.trim(field01).length() == 0) {
            final ActionMessage msg = new ActionMessage("message.blanco.validate.required.selection", "フィールド１");
