/*
 * このクラスは 'AbstractValidateLengthTester12' の具象クラスとして blanco Framework によって自動生成されました。
 */
...
public class ValidateLengthTester12 extends AbstractValidateLengthTester12 {
    /**
     * シリアルバージョン UID.
     */
    ...
    public String validateField01() {
        // [@BlancoValidateLength]
        {
            ...
            if (value.length() == 0) {
                ...
                return "「フィールド１」は 3 文字以下で入力してください。";
            }
        }
        return null;
    }
    ...
    public boolean validateField01(final ActionMessages actionMessages) {
        // [@BlancoValidateLength]
        {
            ...
            if (value.length() == 0) {
                ...
                final ActionMessage msg = new ActionMessage("message.blanco.validate.length.max", "フィールド１", "3");
