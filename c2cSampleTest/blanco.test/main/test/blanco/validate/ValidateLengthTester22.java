/*
 * このクラスは 'AbstractValidateLengthTester22' の具象クラスとして blanco Framework によって自動生成されました。
 */
...
public class ValidateLengthTester22 extends AbstractValidateLengthTester22 {
    /**
     * シリアルバージョン UID.
     */
    ...
    public String validateField01(final String locationInfo) {
        // [@BlancoValidateLength]
        {
            ...
            if (value.length() == 0) {
                ...
                return locationInfo + "「フィールド１」は 3 文字以下で入力してください。";
            }
        }
        return null;
    }
    ...
    public boolean validateField01(final ActionMessages actionMessages, final String locationInfo) {
        // [@BlancoValidateLength]
        {
            ...
            if (value.length() == 0) {
                ...
                final ActionMessage msg = new ActionMessage("message.blanco.validate.length.max.locationinfo", locationInfo, "フィールド１", "3");
