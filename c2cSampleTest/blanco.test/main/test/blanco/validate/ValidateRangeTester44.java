/*
 * このクラスは 'AbstractValidateRangeTester44' の具象クラスとして blanco Framework によって自動生成されました。
 */
...
public class ValidateRangeTester44 extends AbstractValidateRangeTester44 {
    /**
     * 処理対象となるフィールド。
    ...
    public String validateField01(final String locationInfo) {
        ...
        if (field01 == null) {
            ...
            return locationInfo + "「フィールド１」は 3.1 以上で入力してください。";
        }
        return null;
    }
    ...
    public boolean validateField01(final ActionMessages actionMessages, final String locationInfo) {
        ...
        if (field01 == null) {
            ...
            final ActionMessage msg = new ActionMessage("message.blanco.validate.range.min.locationinfo", locationInfo, "フィールド１", "3.1");
