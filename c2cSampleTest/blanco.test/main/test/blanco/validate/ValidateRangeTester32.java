/*
 * このクラスは 'AbstractValidateRangeTester32' の具象クラスとして blanco Framework によって自動生成されました。
 */
...
public class ValidateRangeTester32 extends AbstractValidateRangeTester32 {
    /**
     * 処理対象となるフィールド。
    ...
    public boolean validateField01(final ActionMessages actionMessages) {
        ...
        if (field01 == null || field01.length() == 0) {
            ...
            final ActionMessage msg = new ActionMessage("message.blanco.validate.range.max", "フィールド１", "3.3");
