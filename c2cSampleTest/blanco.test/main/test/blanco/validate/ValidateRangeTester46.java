/*
 * このクラスは 'AbstractValidateRangeTester46' の具象クラスとして blanco Framework によって自動生成されました。
 */
...
public class ValidateRangeTester46 extends AbstractValidateRangeTester46 {
    /**
     * 処理対象となるフィールド。
    ...
    public String validateField01(final String locationInfo) {
        ...
        if (field01 == null) {
            ...
            return locationInfo + "「フィールド１」は 3.1 以上 3.3 以下で入力してください。";
        }
        return null;
    }
    ...
    public boolean validateField01(final ActionMessages actionMessages, final String locationInfo) {
        ...
        if (field01 == null) {
            ...
            final ActionMessage msg = new ActionMessage("message.blanco.validate.range.minmax.locationinfo", locationInfo, "フィールド１", "3.1", "3.3");
