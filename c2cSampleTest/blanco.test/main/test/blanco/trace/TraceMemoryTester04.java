/*
 * このクラスは 'AbstractTraceMemoryTester04' の具象クラスとして blanco Framework によって自動生成されました。
 */
...
public class TraceMemoryTester04 extends AbstractTraceMemoryTester04 {
    /**
     * メモリ・トレースのテスト。
     *
     * @param arg01
    ...
    public void hello(String arg01) {
        ...
        System.out.println("trace: AbstractTraceMemoryTester04#hello(" + arg01 + ") begin.");
        ...
        System.out.println("trace: AbstractTraceMemoryTester04#hello(" + arg01 + ") end. " + (System.currentTimeMillis() - autoValStartTimeMillisec) + "ms");
    }
}
